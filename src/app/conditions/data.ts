...
export const conditions: Condition[] = [
  // VA Disability Conditions
  {
    ...
    longDescription: "Post-Traumatic Stress Disorder (PTSD) is one of the most common conditions affecting veterans. It develops after experiencing or witnessing traumatic events such as combat, military sexual trauma, or other service-related incidents. A physician-authored medical opinion can help establish that your current PTSD symptoms are connected to events that occurred during your military service.",
    symptoms: [
    ...
    howWeHelp: [
      ...
      "Establish the medical opinion between service events and current symptoms",
      "Document how your condition meets VA rating criteria",
    ],
    relatedConditions: ["anxiety", "depression", "tbi", "sleep-apnea"],
    seoTitle: "PTSD Physician-Authored Medical Opinions for VA Claims | Rosen Experts",
    seoDescription: "Get a physician-authored physician-authored medical opinion for your PTSD VA disability claim. Free medical records review. Establish service connection for post-traumatic stress disorder.",
  },
  {
    slug: "tbi",
    ...
    longDescription: "Traumatic Brain Injury (TBI) is common among veterans, particularly those exposed to IED blasts, combat situations, or training accidents. TBI can cause lasting cognitive, physical, and emotional symptoms. A physician-authored medical opinion can help connect your current TBI-related symptoms to documented in-service events.",
    symptoms: [
    ...
    seoTitle: "TBI Physician-Authored Medical Opinions for VA Claims | Rosen Experts",
    seoDescription: "Get a physician-authored physician-authored medical opinion for your traumatic brain injury VA claim. Free medical records review. Establish service connection for TBI.",
  },
  {
    slug: "tinnitus",
    name: "Tinnitus",
    ...
    longDescription: "Tinnitus is one of the most frequently claimed VA disabilities. It commonly results from exposure to loud noises during military service, including weapons fire, explosions, aircraft, and heavy machinery. A physician-authored medical opinion can help establish that your tinnitus is related to noise exposure during your military service.",
    symptoms: [
    ...
    seoTitle: "Tinnitus Physician-Authored Medical Opinions for VA Claims | Rosen Experts",
    seoDescription: "Get a physician-authored physician-authored medical opinion for your tinnitus VA disability claim. Free medical records review. Establish service connection for ringing in the ears.",
  },
  {
    slug: "hearing-loss",
    name: "Hearing Loss",
    ...
    seoTitle: "Hearing Loss Physician-Authored Medical Opinions for VA Claims | Rosen Experts",
    seoDescription: "Get a physician-authored physician-authored medical opinion for your hearing loss VA disability claim. Free medical records review. Establish service connection for noise-induced hearing loss.",
  },
  {
    slug: "sleep-apnea",
    name: "Sleep Apnea",
    ...
    longDescription: "Sleep apnea is a common condition among veterans and is often claimed as secondary to other service-connected conditions like PTSD, weight gain from limited mobility, or nasal/sinus conditions. A physician-authored medical opinion can help establish how your sleep apnea is connected to your military service or aggravated by service-connected conditions.",
    symptoms: [
      "Loud snoring",
    ...
    seoTitle: "Sleep Apnea Physician-Authored Medical Opinions for VA Claims | Rosen Experts",
    seoDescription: "Get a physician-authored physician-authored medical opinion for your sleep apnea VA disability claim. Free medical records review. Establish service connection for obstructive sleep apnea.",
  },
  {
    slug: "back-pain",
    ...
    longDescription: "Back conditions are among the most common disabilities affecting veterans. Military service often involves heavy lifting, carrying equipment, jumping from vehicles, and other activities that can cause or aggravate spine conditions. A physician-authored medical opinion can help connect your current back condition to events or activities during your military service.",
    symptoms: [
    ...
    seoTitle: "Back Condition Physician-Authored Medical Opinions for VA Claims | Rosen Experts",
    seoDescription: "Get a physician-authored physician-authored medical opinion for your back condition VA disability claim. Free medical records review. Establish service connection for spine injuries.",
  },
  {
    ...
    seoTitle: "Knee Condition Physician-Authored Medical Opinions for VA Claims | Rosen Experts",
    seoDescription: "Get a physician-authored physician-authored medical opinion for your knee condition VA disability claim. Free medical records review. Establish service connection for knee injuries.",
  },
